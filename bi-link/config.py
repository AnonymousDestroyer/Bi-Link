...
parser.add_argument('--pretrained-model', default='/home/wanghuadong/pengbohua/SimKGC-main/simcse-bert-base-uncased', type=str, metavar='N',
...
parser.add_argument('--use-amp', default=False, type=bool,
                    help='Use amp if available')
parser.add_argument('--t', default=20, type=float,
                    help='temperature parameter')
parser.add_argument('--hr-tr-s', default=15, type=float,
                    help='temperature parameter')
...
parser.add_argument('--use-self-negative', default=False, type=bool,
                    help='use head entity as negative')
parser.add_argument('--label-smoothing', default=0.9, type=float,
                    help='coefficient for LS')
...
parser.add_argument("--latent-dim", default=128, type=int,
                    help='dim for latent space')
parser.add_argument("--off-diag", default=False, type=bool,
                    help='add off diagonal to contrastive learning')
...
parser.add_argument('--eval-model-path', default='./checkpoint/fb-roberta/model_last.mdl', type=str, metavar='N',
                    help='path to model, only used for evaluation')

args = parser.parse_args()

print(os.path.exists(args.train_path))
